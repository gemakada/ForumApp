...
public class login extends AppCompatActivity {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!email.isEmpty() && !password.isEmpty()) {
                    ...
                    if (response!=null) {
                        if (!(response.equals("Sorry username or password error"))) {
                            ...
                            Toast.makeText(getApplicationContext(),
                                    "Wrong Username or password,Try Again", Toast.LENGTH_LONG)
                                    .show();
                        }
                    }
                    else {
    ...
    public static String Login(String Username,String Password) throws UnsupportedEncodingException {
        ...
        HttpGet request = new HttpGet("http://"+MyGlobal.ip+":8080/ServerForum/Login.do?user=" + i1 + "&pass=" + i2);
